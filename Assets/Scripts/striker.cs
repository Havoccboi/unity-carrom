...
public class striker : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        // Increase or decrease the force applied to the StrikerBG game object based on input
        ...
        Rigidbody strikerRigidbody = StrikerBG.GetComponent<Rigidbody>();
       if (strikerRigidbody != null)
            {
                strikerRigidbody.AddForce(StrikerBG.forward * currentForce);
            }
        */
